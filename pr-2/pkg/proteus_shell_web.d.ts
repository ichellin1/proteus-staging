...
export interface InitOutput {
    ...
    readonly proteusapp_addChild: (a: number, b: number, c: number) => void;
    ...
    readonly proteusapp_centerCropToSquare: (a: number, b: number) => number;
    readonly proteusapp_component: (a: number, b: any) => [number, number, number];
    readonly proteusapp_copyBakedImageFrom: (a: number, b: number, c: number) => number;
    readonly proteusapp_destroy: (a: number, b: number) => void;
    readonly proteusapp_freeResources: (a: number, b: number) => void;
    ...
    readonly proteusapp_removeChild: (a: number, b: number, c: number, d: number) => void;
    readonly proteusapp_setDeclaredGeometry: (a: number, b: number, c: any) => [number, number];
    readonly proteusapp_setInteractive: (a: number, b: number, c: number) => void;
    readonly proteusapp_setTexture: (a: number, b: number, c: number) => number;
