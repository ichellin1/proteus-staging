...
export class ProteusApp {
    ...
    addChild(parent, child) {
        ...
        wasm.proteusapp_addChild(this.__wbg_ptr, parent.__wbg_ptr, child.__wbg_ptr);
    }
    /**
    ...
    destroy(handle) {
        ...
        wasm.proteusapp_destroy(this.__wbg_ptr, ptr0);
    }
    /**
     * @param {Handle} handle
     */
    freeResources(handle) {
        _assertClass(handle, Handle);
        wasm.proteusapp_freeResources(this.__wbg_ptr, handle.__wbg_ptr);
    }
    /**
    ...
    removeChild(parent, child, destroy) {
        _assertClass(parent, Handle);
        _assertClass(child, Handle);
        wasm.proteusapp_removeChild(this.__wbg_ptr, parent.__wbg_ptr, child.__wbg_ptr, destroy);
    }
    /**
    ...
    setInteractive(handle, interactive) {
        _assertClass(handle, Handle);
        wasm.proteusapp_setInteractive(this.__wbg_ptr, handle.__wbg_ptr, interactive);
    }
    /**
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [F64], shim_idx: 110, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
